      ...
      <div className="section-course-bg">
        ...
        <div className="section-course-expire">
          ...
          <div className="flex flex-col gap-30">
            <div className="section-lits-course-expire flex justify-center relative top-13 gap-10 mb-gap-10">
            ...
            <div className="section-lits-course-expire flex-center flex-col relative top-13 gap-10 mb-gap-10">
              <div className="course-list-info relative overflow-hidden flex w-675 h-186 rounded-32 items-center gap-50 pd-0">
                <div className="img-icon w-289 h-auto overflow-hidden rounded-28 overflow-hidden ml-5">
                  <Image src={iconvsq} alt="" />
                </div>
                <div className="text-activity text-start h-178  ">
                  <h3 className="detail-text-activity text-drakblue font-size-28 font-medium">กิจกรรม บอกต่อความประ...</h3>
                  <p className="text-content font-size-24 text-lingblue font-light">แฟต <span className="span-text-content">|</span> 6 CC</p>
                </div>
                <div className="date-text">
                <p className="text-date-1 relative inline-block z-1 text-lingblue font-normal font-size-23 pr-0 ">ถึง 26 ก.ค. 68</p>
                </div>
