...
export default function PDPAModal({ onAccept, onDecline }: PDPAModalProps) {
  ...
  return (
    <div className="pdpa-modal mb-flex-center mb-fixed mb-pl-21 mb-pr-21 mb-pt-87 mb-pb-87">
      <div className="pdpa-content mb-relative mb-w-full mb-h-full mb-rounded-49 mb-pt-45 mb-pl-40 mb-pr-40">
        <p className="headText-pdpa mb-inline mb-font-size-29 mb-font-normal ">ข้อตกลงการใช้บริการ</p>
        <div className="box-text-pdpa mb-pt-33">
          <div className="text-pdpa font-light mb-overflow-y-auto mb-font-size-23">
            <p >
