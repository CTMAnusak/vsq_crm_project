  ...
  return (
    <div className="register-container h-auto flex-start-center flex-col">
      <div className="register-card flex-center flex-col mt-148 mb-mt-148">
        {/* Logo Skeleton */}
        <div className="relative w-475 mb-w-475">
            <div className="mx-auto h-153 mb-h-153">
              {/* <Skeleton variant="text" width="100%" height="100%" /> */}
            </div>
            <div className="successSkeleton-title flex-end-start mx-auto h-80 mb-h-80">
              {/* <Skeleton variant="text" width="39%" height="70%" /> */}
            </div>
        </div>
        <div className="register-content h-auto flex-start-center flex-col mx-auto w-700 mb-244 mb-w-700 mb-mb-244">
          {/* Check Icon Skeleton */}
          <div className="flex flex-col items-center">
            <div className="flex-center w-290 h-290 mt-40 mb-w-290 mb-h-290 mb-mt-40 mb-40 mb-mb-40">
